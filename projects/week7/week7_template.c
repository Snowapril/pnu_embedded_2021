...
void NVIC_Configure(void) { // misc.h 참고
    ...
    NVIC_PriorityGroupConfig(NVIC_PriorityGroup_1); // TODO : NVIC_PriorityGroup_0~4

	// TODO: Initialize the NVIC using the structure 'NVIC_InitTypeDef' and the function 'NVIC_Init'
	
    // Joystick Down
    NVIC_InitStructure.NVIC_IRQChannel = EXTI2_IRQn;// TODO
    ...
    // Joystick Up
    NVIC_InitStructure.NVIC_IRQChannel = EXTI9_5_IRQn;// TODO
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1; // TODO
    ...
    // User S1 Button
    NVIC_InitStructure.NVIC_IRQChannel = EXTI15_10_IRQn; // TODO
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1; // TODO
